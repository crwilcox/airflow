...
with models.DAG(
    ...
    detect_video_label_result = BashOperator(
        bash_command="echo {{ task_instance.xcom_pull('detect_video_label')['annotationResults'][0]['shotLabelAnnotations'][0]['entity']}}",
    ...
    detect_video_explicit_content_result = BashOperator(
        bash_command="echo {{ task_instance.xcom_pull('detect_video_explicit_content')['annotationResults'][0]['explicitAnnotation']['frames'][0]}}",
    ...
    detect_video_shots_result = BashOperator(
        bash_command="echo {{ task_instance.xcom_pull('detect_video_shots')['annotationResults'][0]['shotAnnotations'][0]}}",
