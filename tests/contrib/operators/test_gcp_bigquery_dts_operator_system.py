...
from tests.contrib.operators.test_gcp_bigquery_dts_operator_system_helper import GcpBigqueryDtsTestHelper
...
class GcpBigqueryDtsSystemTest(DagGcpSystemTestCase):
    ...
    def setUp(self):
        super(GcpBigqueryDtsSystemTest, self).setUp()
        self.gcp_authenticator.gcp_authenticate()
        self.helper.create_csv_file()
    ...
    def tearDown(self):
        ...
        self.helper.delete_csv_file()
        self.gcp_authenticator.gcp_revoke_authentication()
        super(GcpBigqueryDtsSystemTest, self).tearDown()
